...
RegisterServerEvent('esx_inventarioUID:getMoneys')
AddEventHandler('esx_inventarioUID:getMoneys', function()
	...
	if xPlayer ~= nil then
	    ...
	    TriggerClientEvent("esx_inventarioUID:setValues", _source, wallet, bank, black_money, society)
	end
