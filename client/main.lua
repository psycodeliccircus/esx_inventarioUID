...
Citizen.CreateThread(function()
	while true do
		Citizen.Wait(500)
		TriggerServerEvent('esx_inventarioUID:getMoneys')
	end

end)

RegisterNetEvent("esx_inventarioUID:setValues")
...
AddEventHandler("esx_inventarioUID:setValues", function(wallet, bank, black_money, society)
